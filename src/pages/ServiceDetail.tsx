        ...
        <div className="bg-[#070c1d]/60 backdrop-blur-md border border-white/10 p-8 md:p-12 text-text rounded-[2rem] shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
               ...
               <a href={`https://api.whatsapp.com/send?phone=${config.contactWhatsapp?.replace(/[^0-9]/g, '') || "243826636212"}&text=${encodeURIComponent(service.whatsappMessage || `Bonjour, je souhaite avoir plus de détails concernant le service: ${service.title}`)}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center border border-gold/50 text-gold shadow-sm px-8 py-3.5 text-xs tracking-[2px] uppercase font-bold transition-all hover:bg-gold/10 hover:border-gold rounded-full">
                 WhatsApp
               </a>
            </div>
          </motion.div>

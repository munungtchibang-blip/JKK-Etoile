              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex flex-col items-stretch gap-2 mb-2">
                  <div className="flex items-center justify-between gap-2">
                    <a 
                      href={`https://wa.me/${"243826636212"}?text=${encodeURIComponent(`Bonjour, je suis intéressé par ce véhicule : ${car.brand} ${car.model} (${car.year}) à ${car.priceStr}.`)}`}
                ...
                return (
                  ...
                  <div className="md:w-1/2 p-8 flex flex-col">
                    ...
                    <div className="mt-auto flex flex-col sm:flex-row items-center justify-center gap-4">
                      ...
                      <a 
                        href={`https://wa.me/${"243826636212"}?text=${encodeURIComponent(`Bonjour, je souhaite avoir plus d'informations concernant ce véhicule : ${car.brand} ${car.model} (${car.year}) à ${car.priceStr}.`)}`}
                        target="_blank" 
